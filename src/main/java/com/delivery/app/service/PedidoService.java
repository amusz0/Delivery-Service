...
import com.delivery.app.entity.dto.GenerarPedidoDTO;
import com.delivery.app.entity.dto.PedidoConDetallesDTO;
  ...
  public ResponseEntity<Resource> exportInvoice(int idCli, int idOrden) {
    ...
    if (optPedido.isPresent()) {
      try {
        ...
        final File imgLogo = ResourceUtils.getFile("classpath:images/logo_negocio.png");
